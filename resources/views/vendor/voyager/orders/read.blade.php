            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered" style="padding-bottom:5px;">
                    <div class="panel-heading" style="border-bottom:0;">
                        <h3 class="panel-title">Order Produk</h3>
                    </div>
                        ...
                        <ul>
                            @foreach ($products as $product)
                                <li class="margin-bottom: 10px;">
                                    ...
                                    <div>Product Nama: {{ $product->nama }}</div>
                                    <div>Product Harga: <?php 
                                        if($product->harga_diskon == 0){echo $product->harga;}else{echo $product->harga_diskon;}?></div>
